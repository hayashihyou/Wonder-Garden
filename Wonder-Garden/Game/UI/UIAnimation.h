...
template <typename T> using UIAnimationApplyFunc = std::function<void(const T&)>;
...
public:
    ...
    /** 再生 */
    void Play() override { m_curve.Play(); }

    /** 停止 */
    void Stop() override { m_curve.Stop(); }

    /** 再生中か */
    bool IsPlay() override { return m_curve.IsPlaying(); }
    ...
    /** アニメーション中の現在の値を取得 */
    float GetCurrendtValue() { return m_curve.GetCurrentValue(); }

    /** アニメーション後の情報を適用する関数を設定 */
    void SetFunc(const UIAnimationApplyFunc<float>& func) { m_applyFunc = func; }
};
...
public:
    ...
    /** アニメーション中の現在の値を取得 */
    Vector2 GetCurrentValue() { return m_curve.GetCurrentValue(); }
...
public:
    ...
    Vector3 GetCurrentValue() { return m_curve.GetCurrentValue(); }
...
public:
    ...
    Vector4 GetCurrendtValue() { return m_curve.GetCurrentValue(); }
